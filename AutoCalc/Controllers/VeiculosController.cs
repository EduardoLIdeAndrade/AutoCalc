    ...
    public class VeiculosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Veiculos != null ? 
                          View(await _context.Veiculos
                          //Exibir apenas conteúdo do usuário logado.
                          .AsNoTracking()
                          .Where(x => x.Usuario == User.Identity.Name)
                          //Exibir apenas conteúdo do usuário logado.
                          .ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Veiculos'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (veiculo.Usuario != User.Identity.Name)
            {
                return NotFound();
            }
            //Apenas Itens do Usuário
        ...
        public async Task<IActionResult> Create([Bind("Id,ModeloDoVeiculo,PlacaDoVeiculo,AnoDoVeiculo,Usuario")] Veiculo veiculo)
        {
            if (ModelState.IsValid)
            {
                //Apenas Itens do Usuário
                veiculo.Usuario = User.Identity.Name;
                //Apenas Itens do Usuário
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ModeloDoVeiculo,PlacaDoVeiculo,AnoDoVeiculo,Usuario")] Veiculo veiculo)
        {
            if (id != veiculo.Id)
            {
                return NotFound();
